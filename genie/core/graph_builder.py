...
This provides the "single source of truth" for computation graphs in Genie.
"""
...
from .graph_interface import Graph, LazyDAGAdapter
...
class GraphBuilder:
    ...
    def __init__(self):
        ...
        # FX operates at module level, Genie needs operation-level capture
