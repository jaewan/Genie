...
class GenieException(Exception):
    """Base exception for all Genie framework errors."""
...
class InterceptionError(GenieException):
    """Error during tensor interception or operation capture."""
    pass


class MaterializationError(GenieException):
    """Error during tensor materialization (execution)."""
    pass


class SchedulingError(GenieException):
    """Error during graph scheduling or placement."""
    pass


class ShapeInferenceError(GenieException):
    """Error during shape inference."""
    pass


class NetworkError(GenieException):
    """Error in network communication or remote execution."""
    pass


class GenieInternalError(GenieException):
...
class PatternMatchError(GenieException):
    """Pattern matching failed (legacy name)."""
    pass


class GraphBuildError(GenieException):
    """Graph construction failed (legacy name)."""
    pass


class OptimizationError(GenieException):
    """Graph optimization failed (legacy name)."""
    pass


class PlacementError(GenieException):
    """Device placement failed (legacy name)."""
    pass


class TransferTimeoutError(GenieException):
    """Transfer timed out (legacy name)."""
    pass


class NotApplicableError(GenieException):
    """
...
class DeviceError(GenieException):
