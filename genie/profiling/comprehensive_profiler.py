"""End-to-end profiler for Genie using a representative synthetic workload."""
...
class ComprehensiveProfiler:
    """Profiles Genie by executing a synthetic subgraph remotely vs locally."""
    ...
    def profile(
        ...
        """Profile Genie remote execution using a representative workload."""
    ...
    def _execute_remote(
        ...
        server_timing_header = response.headers.get("X-Genie-Server-Timing")
