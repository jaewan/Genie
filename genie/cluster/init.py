"""
Genie Cluster Initialization

Main entry point for connecting to Genie cluster.
"""
...
class ClusterState:
    ...
    Manages the state of the Genie cluster including:
...
async def init(
    ...
    **kwargs
    ...
    """
    Initialize Genie cluster connection.
    ...
    if state.initialized:
        logger.warning("Genie already initialized, returning existing state")
        return state
    ...
    logger.info("=" * 60)
    logger.info("Initializing Genie Cluster")
    logger.info("=" * 60)
...
async def shutdown():
    """
    Shutdown Genie cluster connection.
    ...
    if not state.initialized:
        logger.warning("Genie not initialized, nothing to shutdown")
        return
    
    logger.info("Shutting down Genie cluster connection...")
    ...
    logger.info("✅ Genie shutdown complete")
